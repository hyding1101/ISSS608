---
title: "15-2 22  Visualising Geospatial Point Data"
...
## **15-2.3 Geospatial Data Wrangling**
...
### **15-2.3.2 Data Import and Preparation**
...
## **15-2.4 Creating a sf data frame from an aspatial data frame**
...
## **15-2.5 Drawing Proportional Symbol Map**
...
### **15-2.5.1 It all started with an interactive point symbol map**
...
### **15-2.5.2 Lets make it proportional**
...
### **15-2.5.3 Lets give it a different colour**
...
### **15-2.5.4 I have a twin brothers :)**
...
-   **Splits the map into multiple facets, with each facet representing a different `OUTLET TYPE`.**

-   **Key parameter explanations**:

    -   `by = "OUTLET TYPE"` → **Divides the map into separate facets based on the `OUTLET TYPE` variable.**

    -   `nrow = 1` → **Arranges the facets in a single row (horizontally).**

    -   `sync = TRUE` → **Ensures that all facets share the same zoom level and map extent.**
:::
...
## **15-2.6.1 All about tmap package**
...
## **15-2.6.2 Geospatial data wrangling**
