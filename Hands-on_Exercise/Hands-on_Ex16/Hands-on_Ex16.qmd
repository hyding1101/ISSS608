---
title: "16 Modelling, Visualising and Analysing Network Data with R"
...
### **16.2.1 Installing and launching R packages**
...
### **16.3.1 The edges data**

-   *GAStech-email_edges.csv* which consists of two weeks of 9063 emails correspondances between 55 employees.

### **16.3.2 The nodes data**

-   *GAStech_email_nodes.csv* which consist of the names, department and title of the 55 employees.

### **16.3.3 Importing network data from files**
...
### **16.3.4 Reviewing the imported data**
...
### **16.4.2 The dplyr verbs in tidygraph**
...
### **16.4.3 Using `tbl_graph()` to build tidygraph data model.**

In this section, you will use `tbl_graph()` of **tinygraph** package to build an tidygraph’s network graph data.frame.

Before typing the codes, here are the reference guide of [`tbl_graph()`](https://tidygraph.data-imaginist.com/reference/tbl_graph.html)
...
### **16.4.4 Reviewing the output tidygraph’s graph object**
...
### **16.4.5 Reviewing the output tidygraph’s graph object**
...
### **16.4.6 Changing the active object**
...
You can visit the reference guide of [*activate()*](https://tidygraph.data-imaginist.com/reference/activate.html) to find out more about the function.

## **16.5 Plotting Static Network Graphs with ggraph package**
...
### **16.5.1 Plotting a basic network graph**
...
### **16.5.2 Changing the default network graph theme**
...
### **16.5.3 Changing the coloring of the plot**
...
### **16.5.4 Working with ggraph’s layouts**
...
### **16.5.5 Fruchterman and Reingold layout**
...
### **16.5.6 Modifying network nodes**
...
### **16.6.1 Working with *facet_edges()***
...
### **16.6.2 Working with *facet_edges()***
...
### **16.6.4 Working with *facet_nodes()***
...
## **16.7 Network Metrics Analysis**

### **16.7.1 Computing centrality indices**
...
### **16.7.2 Visualising network metrics**
...
## **16.8 Building Interactive Network Graph with visNetwork**
...
### **16.8.2 Plotting the first interactive network graph**
...
### **16.8.4 Working with visual attributes - Nodes**
...
### **16.8.5 Working with visual attributes - Edges**
